...
void print_SortingStats( SortingStats * stats )
{
	if( stats->bubblesort.compares )
	{
		stats->bubblesort.comparesPct = 
			(int)(100 * stats->bubblesort.compares / stats->bubblesort.compares);
		stats->insertionsort.comparesPct = 
			(int)(100 * stats->insertionsort.compares / stats->bubblesort.compares);
		stats->mergesort.comparesPct = 
			(int)(100 * stats->mergesort.compares / stats->bubblesort.compares);
		stats->quicksort.comparesPct = 
			(int)(100 * stats->quicksort.compares / stats->bubblesort.compares);
	}

	if( stats->bubblesort.moves )
	{
		stats->bubblesort.movesPct = 
			(int)(100 * stats->bubblesort.moves / stats->bubblesort.moves);
		stats->insertionsort.movesPct = 
			(int)(100 * stats->insertionsort.moves / stats->bubblesort.moves);
		stats->mergesort.movesPct = 
			(int)(100 * stats->mergesort.moves / stats->bubblesort.moves);
		stats->quicksort.movesPct = 
			(int)(100 * stats->quicksort.moves / stats->bubblesort.moves);
	}

	if( stats->bubblesort.sortTime )
	{
		stats->bubblesort.sortTimePct = 
			(int)(100 * stats->bubblesort.sortTime / stats->bubblesort.sortTime);
		stats->insertionsort.sortTimePct = 
			(int)(100 * stats->insertionsort.sortTime / stats->bubblesort.sortTime);
		stats->mergesort.sortTimePct = 
			(int)(100 * stats->mergesort.sortTime / stats->bubblesort.sortTime);
		stats->quicksort.sortTimePct = 
			(int)(100 * stats->quicksort.sortTime / stats->bubblesort.sortTime);
	}
